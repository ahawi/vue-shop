  ...
  <div
    ...
    <div class="product-info__actions">
      ...
      <Button
        v-else
        size="l"
        class="product-info__actions-button-sold"
        disabled
        >Нет в наличии</Button
      >
      <div
        class="product-info__actions-bonus"
        v-if="product?.inStock">
        <svg
          width="24"
          height="24"
        ...
        <Typography
          ...
          <Typography
            ...
            size="xs"
            bold
            >10 бонусов</Typography
          >
        </Typography>
      </div>

      <Button class="product-info__actions-notify">
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
        ...
        <Typography
          ...
          size="xs"
          v-else
          >Уведомить о наличии</Typography
        >
      </Button>
    </div>
